...
class _AccountSettingsScreenState extends State<AccountSettingsScreen> {
  ...
  void initState() {
    ...
    accountBloc.listen((state) {
      ...
      if (state is UpdateAccountDetailsFailedState) {
        //show error
        showSnack('Aggiornamento dati non riuscito.', context);
      }
  ...
  Future updateAccountDetails() async {
    if (_formKey.currentState.validate()) {
      ...
      user.name = name;
      user.email = email;
      user.mobileNo = '$prefixCode$mobileNo';
  ...
  Future cropImage(context) async {
    ...
    if (croppedFile != null) {
      print('Dimensioni File: ' + croppedFile.lengthSync().toString());
      setState(() {
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              TextFormField(
                                ...
                                validator: (String val) {
                                  if (val.trim().isEmpty) {
                                    return 'Per favore, indica il Numero Cel.';
                                  }
                              ...
                              TextFormField(
                                ...
                                validator: (String val) {
                                  if (val.trim().isEmpty) {
                                    return 'Per favore, inserisci l\'indirizzo email';
                                  }
                                  if (!RegExp(
