...
import 'package:grocery_store/screens/paypal_payment_screen.dart';
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    checkoutBloc.listen((state) {
      ...
      if (state is PlaceOrderFailedState) {
        if (proceed) {
          Navigator.pop(context);
          showSnack('Invio ordine non riuscito.', context);
          proceed = false;
        }
      }
    });
  ...
  void _handlePaymentError(PaymentFailureResponse response) {
    ...
    print(response);
    Navigator.pop(context);
    showSnack('Pagamento non riscito.', context);
    proceed = false;
  }
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          widget.cartValues.paymentMethods.razorpay
                              ...
                              : SizedBox(),
                          // widget.cartValues.paymentMethods.paypal
                          //     ? RadioListTile(
                          //         activeColor: Theme.of(context).primaryColor,
                          //         dense: true,
                          //         value: 4,
                          ...
                          return Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  'Caricamento dati di consegna non riuscito.',
                          ...
                          return Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  '${user.address[int.parse(user.defaultAddress)].addressLine1}, ${user.address[int.parse(user.defaultAddress)].houseNo} ${user.address[int.parse(user.defaultAddress)].addressLine2}\n${user.address[int.parse(user.defaultAddress)].pincode} - ${user.address[int.parse(user.defaultAddress)].city} (${user.address[int.parse(user.defaultAddress)].state}) - ${user.address[int.parse(user.defaultAddress)].country}\nCitofono: ${user.address[int.parse(user.defaultAddress)].landmark}',
                                  style: GoogleFonts.poppins(
                                    color: Colors.black.withOpacity(0.7),
                                    fontSize: 14.0,
                                    fontWeight: FontWeight.w500,
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: Text(
                                  'Ottieni il ${widget.cartValues.cartInfo.discountPer}% di sconto per ordini superiori a ${Config().currency}${widget.cartValues.cartInfo.discountAmt}',
                                  style: GoogleFonts.poppins(
                                    color: Colors.black87,
                                    fontSize: 15.5,
                                    fontWeight: FontWeight.w600,
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        Text(
                                          'Cod. Sconto (${widget.coupon.couponCode}):',
                                          style: GoogleFonts.poppins(
                                            color:
                  ...
                  if (selectedPayment != 0) {
                    if (user.address.length > 0) {
                      if (user.mobileNo.isNotEmpty) {
                        ...
                        showSnack(
                            'Per favore, aggiungi un Numero Cellulare al tuo account', context);
                      }
                    } else {
                      showSnack('Per favore, aggiungi un indirizzo', context);
                    }
                  } else {
                    showSnack('Seleziona un metodo di pagamento', context);
                  }
                },
                color: Theme.of(context).primaryColor,
                shape: RoundedRectangleBorder(
