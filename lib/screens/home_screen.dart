...
void checkAppleAvailability() async {
if(await AppleSignIn.isAvailable()) {
Provider.of<StateProvider>(context, listen: false).changeAppleAvailable(true);
}
}
  ...
  void initState()  {
    ...
    cartBloc.listen((state) {
      if (state is AddToCartInProgressState) {
        showSnackAdding('Aggiungo al Carrello...');
      }
      if (state is AddToCartCompletedState) {
        Navigator.pop(context);
        showSnack('Aggiunto al Carrello');
      }
    });
