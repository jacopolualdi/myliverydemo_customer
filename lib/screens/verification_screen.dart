  ...
  void initState() {
    ...
    signupBloc.listen((state) {
      ...
      if (state is VerificationFailed) {
        ...
        showFailedSnakbar('Invio Codice OTP non riuscito');
        setState(() {
          inProgress = false;
        });
      }
      ...
      if (state is FailedSavingUserDetails) {
        ...
        showFailedSnakbar('Salvataggio dati utente non riuscito.');
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            Text(
              'È stato inviato un Codice OTP al tuo numero cellulare',
              style: GoogleFonts.poppins(
