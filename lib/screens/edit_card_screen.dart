  ...
  void initState() {
    ...
    cardBloc.listen((state) {
      if (state is EditCardFailedState) {
        // error
        print('ERROR');
        showSnack('Modifica Carta non riuscita');
        isEdited = false;
      }
      if (state is EditCardInProgressState) {
        print('Modifica Carta in corso');
      }
      ...
      if (state is DeleteCardFailedState) {
        // error
        print('ERROR');
        showSnack('Rimozione Carta non riuscita');
        isEdited = false;
      }
      if (state is DeleteCardInProgressState) {
        print('Rimozione Carta in corso');
      }
      if (state is DeleteCardCompletedState) {
        if (isEdited) {
          print('ADDED');
          Navigator.pop(context, true);
        }
                  ...
                  child: FlatButton(
                    onPressed: () {
                      ...
                      if (cardNo.toString().trim().length < 19 ||
                        ...
                        //show snack
                        showSnack('Dati Carta non validi');
                      } else {
