...
class _ProfilePageState extends State<ProfilePage>
  ...
  void initState() {
    ...
    signinBloc.listen((state) {
      ...
      if (state is SignoutFailed) {
        //show failed dialog
        if (isSigningOut) {
          showSnack('Disconnessione non riuscita.', context);
          isSigningOut = false;
        }
      }
  ...
  Future inviteAFriend() async {
    await FlutterShare.share(
      title: 'Ordina dalla App di Mylivery!',
      text: 'Mylivery',
      linkUrl:
          'https://play.google.com/store/apps/details?id=com.mylivery.democustomer',
  ...
  Future feedback() async {
    final Email email = Email(
      body: '',
      subject: 'Mylivery Demo - Supporto',
      isHTML: false,
      recipients: ['info@mylivery.app'],
    );
