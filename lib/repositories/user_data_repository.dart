...
class UserDataRepository extends BaseRepository {
  ...
  Future<bool> addToCart(
    ...
    String totalPrice,
      ...
      userDataProvider.addToCart(
          productId, uid, addedExtras, seletedSize, totalPrice);
  ...
  Future<bool> increaseQuantity(
          String quantity, String uid, String productId, String itemId) =>
      userDataProvider.increaseQuantity(quantity, uid, productId, itemId);

  Future<bool> decreaseQuantity(
          String quantity, String uid, String productId, String itemId) =>
      userDataProvider.decreaseQuantity(quantity, uid, productId, itemId);
  ...
  Future<bool> deleteCard(Map<String, dynamic> card, int index) =>
      userDataProvider.deleteCard(card, index);
  ...
  //CLOSING HOURS
  Future<ClosingHours> getClosingHours() => userDataProvider.getClosingHours();
  Future<bool> updateClosingHours(ClosingHours map) =>
      userDataProvider.updateClosingHours(map);

  //Notification products
  Future<List<Product>> getNotifProducts(String type) =>
      userDataProvider.getNotifProducts(type);
