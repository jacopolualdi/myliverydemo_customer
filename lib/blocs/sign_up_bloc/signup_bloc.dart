...
class SignupBloc extends Bloc<SignupEvent, SignupState> {
  ...
  Stream<SignupState> mapSignupWithAppleEventToState() async* {
    yield SignUpInProgress();

    try {
      User firebaseUser = await authenticationRepository.signUpWithApple();
      if (firebaseUser != null) {
        yield SignupWithAppleInitialCompleted(firebaseUser);
      } else {
        yield SignupWithAppleInitialFailed();
      }
    } catch (e) {
      print(e);
      yield SignupWithAppleInitialFailed();
