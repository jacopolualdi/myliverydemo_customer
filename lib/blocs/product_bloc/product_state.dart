...
class GetNotifProductsFailedState extends ProductState {
  @override
  String toString() => 'GetNotifProductsFailedState';
}

class GetNotifProductsInProgressState extends ProductState {
  @override
  String toString() => 'GetNotifProductsInProgressState';
}

class GetNotifProductsCompletedState extends ProductState {
  final List<Product> productList;

  GetNotifProductsCompletedState(this.productList);
  @override
  String toString() => 'GetNotifProductsCompletedState';
}
